...
And for any ellipse, there are two possible arcs that you can draw in them — again, one _clockwise_ and one _counterclockwise_. This gives us a total of **four possible arcs** for any given pair of points!

---

The `large-arc-flag` and `sweep-flag` arguments control which of these four arcs are drawn.
