...
export function Editor({ questionKey }: { questionKey: string }) {
    const {
        data: { showAnswer },
        set,
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-between relative">
                ...
                <button
                    className="pl-2 pr-1 hover:bg-gray6 text-gray11 font-medium rounded-md flex gap-1 items-center group relative bg-gray4"
...
function PathReference() {
    return (
        <div className="space-y-6 divide-y divide-gray8 divide-dashed">
            <section>
                <h3 className="font-medium text-gray11 mb-4">Cursors & Lines</h3>
            ...
            <section className="pt-4">
                <h3 className="font-medium text-gray11 mb-4">Curves</h3>
