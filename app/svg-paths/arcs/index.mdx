...
Once you've picked a direction, you still have two arcs to choose from, with one arc being larger than the other. The `large-arc` flag lets you pick one of these arcs, with `0` meaning the smaller arc is picked.
