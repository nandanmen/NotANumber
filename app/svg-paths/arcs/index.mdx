...
Of course, it's not always possible to find a matching ellipse. What happens in that case? In the sandbox, you can make this happen by **reducing the radii of the ellipse or moving the endpoint farther away from the start point**.
