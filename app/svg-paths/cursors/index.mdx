...
Where the current path section ends up depends on whether the command is **absolute** or **relative** (which, if you recall, depends on whether the command code is uppercase or lowercase).
