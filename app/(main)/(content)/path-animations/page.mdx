...
This is relevant because Figma's `fill` and `stroke` styles map 1-to-1 to SVG attributes when you export vectors to SVG.

<Callout>

I've written extensively on how Figma's SVG export works in my SVG course, [Interactive SVG Animations](https://svg-animations.how). Check out the course or the [corresponding blog post](https://courses.nan.fyi/blog/svg/animating-figma-exports) if you're interested!
