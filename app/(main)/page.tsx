    ...
    <div>
      ...
      <div className="relative z-10 mx-auto md:px-4 w-full max-w-[1450px]">
        <div className="lg:grid grid-cols-[320px_1fr] bg-gray4 md:border-x border-gray8 relative">
          <aside className="p-6 pt-12 lg:p-10 border-gray8 top-0 flex flex-col gap-6 relative border-b lg:border-b-0 lg:border-r-0 lg:sticky lg:h-screen">
            ...
            <div className="md:flex lg:block lg:space-y-8 space-y-6 md:space-y-0 items-center justify-between">
              <p className="leading-relaxed">
                <Balancer>
                  Interactive blog posts on computer science and web development
                  by{" "}
                  <a
          ...
          <div className="lg:border-l border-gray8">
