...
Putting a binary tree on disk isn't exactly straightforward because the way data is accessed on a disk (or other persistent storage device) is different from how it's accessed in memory.
