...
import { Tokenizer } from "./_components/Tokenizer";
...
\* Can you spot these three parts in the visualization?
...
<Wide>
  <TokenList type={["keyword", "identifier"]} toggleable />
</Wide>
...
Next up is tokenizing the `'hello, world!'` part of the code snippet, also known as a **string literal**.

<Wide>
  <TokenList type={["string"]} toggleable />
</Wide>
...
\* This is a great example of microsyntax! By handling the string rules here, other parts of the compiler don't have to worry about whether this string is "correct" or not.
