import { BGPPathFindingSequenceList, BGPPlayButton, BGPScrollVisual } from "./_components/bgp";
...
3. Router 2 will then announce to router 1 that it can receive all addresses starting with `3.x`. Router 1 will then update its routing table.
