...
import { SearchIndex } from "./_components/search-index";
import { UpdateIndex } from "./_components/update-index";
import { SparseIndex, SearchSparseIndex } from "./_components/sparse-index";
import { LSM, LSMVisual, MobileWrapper, CompactionControls } from "./_components/lsm";
...
<Aside label="In-Memory vs. On-Disk">
...
<SmallOnly className="grid gap-5">
  <Compaction />
</SmallOnly>
