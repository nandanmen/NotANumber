...
import * as HeavyRectangle from './components/HeavyRectangle/HeavyRectangle.stories'
...
import * as EdgeRotationProblem from './_dist-content/heavy-rectangle/components/EdgeRotationProblem/EdgeRotationProblem.stories'
import * as EdgeRotationVisualizer from './_dist-content/heavy-rectangle/components/EdgeRotationVisualizer/EdgeRotationVisualizer.stories'
import * as HeavyRectangleVisualizer from './_dist-content/heavy-rectangle/components/HeavyRectangleVisualizer/HeavyRectangleVisualizer.stories'
import * as HorizontalCurve from './_dist-content/heavy-rectangle/components/HorizontalCurve/HorizontalCurve.stories'
import * as TrigonometryFunctions from './_dist-content/heavy-rectangle/components/TrigonometryFunctions/TrigonometryFunctions.stories'
import * as TrigonometrySize from './_dist-content/heavy-rectangle/components/TrigonometrySize/TrigonometrySize.stories'
...
export const stories = [{ name: `components`, stories: [{ name: 'Checkbox', variants: Checkbox },{ name: 'HeavyRectangle', variants: HeavyRectangle },{ name: 'Debugger', variants: Debugger },{ name: 'FramerMagicMotion', variants: FramerMagicMotion },{ name: 'HowArraysWork', variants: HowArraysWork },{ name: 'SlidingWindow', variants: SlidingWindow },{ name: 'TokenizerVisual', variants: TokenizerVisual },{ name: 'Link', variants: Link },{ name: 'MobileNavIsland', variants: MobileNavIsland },{ name: 'PrimaryButton', variants: PrimaryButton },{ name: 'Quiz', variants: Quiz },{ name: 'Sandbox', variants: Sandbox },{ name: 'SubscribeButton', variants: SubscribeButton },{ name: 'SvgGridWrapper', variants: SvgGridWrapper },{ name: 'Visualizer', variants: Visualizer }] },
{ name: `heavy-rectangle`, stories: [{ name: 'EdgeRotationProblem', variants: EdgeRotationProblem },{ name: 'EdgeRotationVisualizer', variants: EdgeRotationVisualizer },{ name: 'HeavyRectangleVisualizer', variants: HeavyRectangleVisualizer },{ name: 'HorizontalCurve', variants: HorizontalCurve },{ name: 'TrigonometryFunctions', variants: TrigonometryFunctions },{ name: 'TrigonometrySize', variants: TrigonometrySize }] },
