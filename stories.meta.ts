...
{ name: `build-your-own-database`, stories: [{ name: 'AppendOnlyFile', variants: AppendOnlyFile },{ name: 'FileDatabase', variants: FileDatabase },{ name: 'FileDatabaseExample', variants: FileDatabaseExample }] },
