...
import * as Button from './_dist-content/glowing-border-button/components/Button/Button.stories'
import * as ButtonSequence from './_dist-content/glowing-border-button/components/ButtonSequence/ButtonSequence.stories'
...
{ name: `glowing-border-button`, stories: [{ name: 'Button', variants: Button },{ name: 'ButtonSequence', variants: ButtonSequence }] },
