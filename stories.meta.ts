...
{ name: `magic-motion`, stories: [{ name: 'FlipExample', variants: FlipExample },{ name: 'FlipFirst', variants: FlipFirst },{ name: 'FlipInverse', variants: FlipInverse },{ name: 'FlipLast', variants: FlipLast },{ name: 'FlipLastReact', variants: FlipLastReact },{ name: 'FlipOverview', variants: FlipOverview },{ name: 'FlipPlay', variants: FlipPlay },{ name: 'InitialPositionSandbox', variants: InitialPositionSandbox },{ name: 'InverseSandbox', variants: InverseSandbox },{ name: 'InverseSizeSlider', variants: InverseSizeSlider },{ name: 'MotionSandbox', variants: MotionSandbox },{ name: 'PlaySandbox', variants: PlaySandbox },{ name: 'SizeDiagram', variants: SizeDiagram },{ name: 'SizeDistanceRelationship', variants: SizeDistanceRelationship },{ name: 'SizeLayoutExample', variants: SizeLayoutExample },{ name: 'SizeMeasurements', variants: SizeMeasurements },{ name: 'SizePlayAnimation', variants: SizePlayAnimation }] },
