...
{ name: `experiments`, stories: [{ name: 'ControllableAnimation', variants: ControllableAnimation },{ name: 'TextLoadAnimation', variants: TextLoadAnimation },{ name: 'TopDownParser', variants: TopDownParser }] }];