...
import * as IncorrectInverseAnimation from './_dist-content/magic-motion/components/IncorrectInverseAnimation/IncorrectInverseAnimation.stories'
...
export const stories = [{ name: `components`, stories: [{ name: 'Quiz', variants: Quiz },{ name: 'Sandbox', variants: Sandbox }] },
{ name: `magic-motion`, stories: [{ name: 'CorrectedInverseAnimation', variants: CorrectedInverseAnimation },{ name: 'FlipExample', variants: FlipExample },{ name: 'FlipFirst', variants: FlipFirst },{ name: 'FlipInverse', variants: FlipInverse },{ name: 'FlipLast', variants: FlipLast },{ name: 'FlipLastReact', variants: FlipLastReact },{ name: 'FlipOverview', variants: FlipOverview },{ name: 'FlipPlay', variants: FlipPlay },{ name: 'IncorrectInverseAnimation', variants: IncorrectInverseAnimation },{ name: 'InitialPositionSandbox', variants: InitialPositionSandbox },{ name: 'InverseSandbox', variants: InverseSandbox },{ name: 'InverseSizeSlider', variants: InverseSizeSlider },{ name: 'MotionSandbox', variants: MotionSandbox },{ name: 'PlaySandbox', variants: PlaySandbox },{ name: 'HorizontalRuler', variants: HorizontalRuler },{ name: 'SizeDiagram', variants: SizeDiagram },{ name: 'SizeDistanceRelationship', variants: SizeDistanceRelationship },{ name: 'SizeLayoutExample', variants: SizeLayoutExample },{ name: 'SizeMeasurements', variants: SizeMeasurements },{ name: 'SizePlayAnimation', variants: SizePlayAnimation }] },
