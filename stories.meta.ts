...
import * as InteractivePathPlayground from './components/InteractivePathPlayground/InteractivePathPlayground.stories'
...
import * as ArcDirection from './_dist-content/paths/components/arcs/ArcDirection/ArcDirection.stories'
import * as ArcVisual from './_dist-content/paths/components/arcs/ArcVisual.stories'
...
export const stories = [{ name: `components`, stories: [{ name: 'Checkbox', variants: Checkbox },{ name: 'Counter', variants: Counter },{ name: 'Debugger', variants: Debugger },{ name: 'FramerMagicMotion', variants: FramerMagicMotion },{ name: 'FramerMotionKeys', variants: FramerMotionKeys },{ name: 'HowArraysWork', variants: HowArraysWork },{ name: 'SlidingWindow', variants: SlidingWindow },{ name: 'TokenizerVisual', variants: TokenizerVisual },{ name: 'InteractivePathPlayground', variants: InteractivePathPlayground },{ name: 'Link', variants: Link },{ name: 'MobileNavIsland', variants: MobileNavIsland },{ name: 'PathPlayground', variants: PathPlayground },{ name: 'PathVisualizer', variants: PathVisualizer },{ name: 'PrimaryButton', variants: PrimaryButton },{ name: 'Quiz', variants: Quiz },{ name: 'Sandbox', variants: Sandbox },{ name: 'SubscribeButton', variants: SubscribeButton },{ name: 'SvgGridWrapper', variants: SvgGridWrapper },{ name: 'Visualizer', variants: Visualizer }] },
...
{ name: `paths`, stories: [{ name: 'ArcDirection', variants: ArcDirection },{ name: 'ArcVisual', variants: ArcVisual },{ name: 'PageSection', variants: PageSection },{ name: 'PathEditor', variants: PathEditor }] },
