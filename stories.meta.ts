...
{ name: `build-your-own-database`, stories: [{ name: 'AppendOnlyFile', variants: AppendOnlyFile },{ name: 'FileDatabase', variants: FileDatabase },{ name: 'FileDatabaseExample', variants: FileDatabaseExample },{ name: 'SingleFileCompaction', variants: SingleFileCompaction }] },
...
{ name: `experiments`, stories: [{ name: 'BezierCurveQuiz', variants: BezierCurveQuiz },{ name: 'ControllableAnimation', variants: ControllableAnimation },{ name: 'EasingCurveEditor', variants: EasingCurveEditor },{ name: 'EasingFunctionSandbox', variants: EasingFunctionSandbox },{ name: 'TextLoadAnimation', variants: TextLoadAnimation },{ name: 'TopDownParser', variants: TopDownParser }] }];