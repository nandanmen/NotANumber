...
{ name: `experiments`, stories: [{ name: 'ControllableAnimation', variants: ControllableAnimation },{ name: 'EasingFunctionSandbox', variants: EasingFunctionSandbox },{ name: 'TextLoadAnimation', variants: TextLoadAnimation },{ name: 'TopDownParser', variants: TopDownParser }] }];