...
import * as CodeQuiz from './_dist-content/keys-in-framer-motion/components/CodeQuiz/CodeQuiz.stories'
...
{ name: `keys-in-framer-motion`, stories: [{ name: 'CodeQuiz', variants: CodeQuiz }] },
