...
In the example above, we can get the sum of the **second subarray by subtracting 1 and adding 5** to the sum of the first. This is the key insight in getting to the optimal solution for this problem.
