...
To keep things simple, I've opted to support both multiple lines and **only apostrophes**.

<Callout label="What about `these strings`?">

JavaScript also supports writing strings using backticks like this: \`hello world\`.
