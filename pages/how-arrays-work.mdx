...
Just like arrays, you can use the index to quickly read and write to a specific location in memory. However, when we're talking about memory in particular, we tend to talk about the index of any individual byte as its _address_.
