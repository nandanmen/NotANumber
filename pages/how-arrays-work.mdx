...
Using only the address of the _very first byte_, how would we get the address of the element at index 0? What about index 1? Or index 2?
...
Let's answer these questions one at a time, starting with the former - making the array grow.
