...
By far my favourite part about Framer Motion is its seemingly-magical layout animation API. Put the `layout` prop to any Framer Motion component and that component will seamlessly animate from one position on the page to the next:
