...
I opted to not implement things this way because I didn't want to take away from the core scale correction concept. If you're interested though, [this part of the Framer Motion source code]() seems to be a good place to start — it looks like they maintain their own DOM-like tree of motion components!
