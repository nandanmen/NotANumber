...
Our algorithm first lines up the top left of the final position with the top left point of the original position, and then it scales it down to the initial size.
