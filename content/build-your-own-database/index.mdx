...
"Old" is the keyword here—because we're not merging data from the current "active" segment, that segment can freely accept new records:

```
active segment new writes
```
